...
namespace Readify.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        // GET /api/books
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] string? q, [FromQuery] int? categoryId, [FromQuery] string? author, [FromQuery] int page = 1, [FromQuery] int pageSize = 10)
        {
